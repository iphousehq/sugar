...
namespace Sugar.Net
{
    ...
    public class UserAgentTest
    {
        ...
        public void TestUserAgents()
        {
            ...
            Assert.AreEqual("Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:25.0) Gecko/20100101 Firefox/25.0", UserAgent.Firefox().ToString());
            Assert.AreEqual("Mozilla/5.0 (Windows NT 6.2; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1667.0 Safari/537.36", UserAgent.Chrome().ToString());
